...
class EmployeeTest extends TestCase
{
    ...
    #[Test]
    public function it_has_no_user_when_the_employee_never_got_an_account(): void
    {
        $employee = Employee::factory()->create();

        $this->assertFalse($employee->user()->exists());
    ...
    #[Test]
    public function it_casts_the_dates(): void
    {
        $employee = Employee::factory()->create([
            'hired_at' => '2005-03-24',
            'departed_at' => '2013-05-16',
            'date_of_birth' => '1964-03-15',
        ]);

        $this->assertInstanceOf(Carbon::class, $employee->hired_at);
        $this->assertInstanceOf(Carbon::class, $employee->departed_at);
