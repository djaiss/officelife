...
class OfficeControllerTest extends TestCase
{
    ...
    public function it_shows_the_offices_of_the_company(): void
    {
        ...
        $response = $this->actingAs($user)->get(route('settings.offices.index'));
    ...
    public function it_orders_the_offices_by_city_when_the_path_asks_for_it(): void
    {
        ...
        Office::factory()->create(['company_id' => $user->company_id, 'name' => 'Scranton branch', 'city' => 'Akron']);
        Office::factory()->create(['company_id' => $user->company_id, 'name' => 'Nashua branch', 'city' => 'Utica']);

        $response = $this->actingAs($user)->get(route('settings.offices.index', ['sort' => 'place']));
    ...
    public function it_shows_the_archived_offices_on_a_path_of_their_own(): void
    {
        ...
        $response = $this->actingAs($user)->get(route('settings.offices.index', 'archived'));
    ...
    public function it_shows_every_office_on_the_third_path(): void
    {
        ...
        $response = $this->actingAs($user)->get(route('settings.offices.index', 'all'));
    ...
    public function it_narrows_the_list_down_to_what_was_searched_for(): void
    {
        ...
        $response = $this->actingAs($user)->get(route('settings.offices.index', ['q' => 'utica']));
    ...
    public function it_turns_away_a_scope_it_does_not_know(): void
    {
        ...
        $this->actingAs($user)->get('settings/administration/offices/somewhere')->assertNotFound();
    }
    ...
    public function it_hides_the_screen_from_somebody_who_may_not_administer_the_company(): void
    {
        ...
        $this->actingAs($user)->get(route('settings.offices.index'))->assertNotFound();
    }
    ...
    public function it_creates_an_office(): void
    {
        ...
        $response = $this->actingAs($user)->post(route('settings.offices.create'), [
    ...
    public function it_sends_the_new_office_messages_to_a_bag_of_their_own(): void
    {
        ...
        $response = $this->actingAs($user)
            ...
            ->post(route('settings.offices.create'), ['name' => '']);

        $response->assertRedirect(route('settings.offices.index'));
        $response->assertSessionHasErrorsIn('createOffice', ['name']);
    }
    ...
    public function it_turns_away_a_country_that_is_not_two_letters(): void
    {
        ...
        $response = $this->actingAs($user)
            ->from(route('settings.offices.index'))
            ->post(route('settings.offices.create'), ['name' => 'Scranton branch', 'country' => 'USA']);

        $response->assertSessionHasErrorsIn('createOffice', ['country']);
    }
    ...
    public function it_saves_an_office(): void
    {
        ...
        $response = $this->actingAs($user)
            ->from(route('settings.offices.index'))
            ->put(route('settings.offices.update', $office->id), [
        ...
        $this->assertTrue($office->is_head_office);
    }
    ...
    public function it_goes_back_to_the_list_the_save_was_made_from(): void
    {
        ...
        $this->actingAs($user)
            ...
            ->put(route('settings.offices.update', $office->id), ['name' => 'Nashua branch'])
            ->assertRedirect(route('settings.offices.index', 'archived'));
    }
    ...
    public function it_cannot_save_an_office_of_another_company(): void
    {
        ...
        $this->actingAs($user)
            ->put(route('settings.offices.update', $office->id), ['name' => 'Stamford branch'])
            ->assertNotFound();
    }
    ...
    public function it_stops_somebody_who_may_not_administer_the_company_from_adding_an_office(): void
    {
        ...
        $this->actingAs($user)
            ->post(route('settings.offices.create'), ['name' => 'Scranton branch'])
            ->assertNotFound();
    }
